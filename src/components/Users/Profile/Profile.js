...
import { loginUserAction, userProfileAction,followUserAction,unfollowUserAction } from "../../../redux/slices/users/usersSlices";
...
export default function Profile() {
  ...
  const {
    profile,profileLoading,profileAppErr,profileServerErr, followed,
    unFollowed,
