            ...
            <div class="py-6 h-screen">
                <div class="flex border border-grey rounded shadow-lg h-full">
                    ...
                    <div class="w-2/3 border flex flex-col">
                        ...
                        <div class="flex-1 overflow-auto bg-gray-300">
                            <div class="py-2 px-3">

                                <div class="flex justify-center mb-2">
                                    <div class="rounded py-2 px-4 bg-yellow-800" >
                                ...
                                <div class="flex mb-2">
                                    <div class="rounded py-2 px-3 bg-rose-800" >
                                ...
                                <div class="flex justify-end mb-2">
                                    <div class="rounded py-2 px-3 bg-pink-900" >
                                        <p class="text-sm mt-1">
                                            Count me in
                                        </p>
                                        <p class="text-right text-xs text-grey-dark mt-1">
                        ...
                        <div class="bg-grey-lighter px-4 py-4 flex items-center">
                            ...
                            {/* <div>
                                <svg xmlns="http://www.w3.org/2000/svg" className='pointer' viewBox="0 0 24 24" width="24" height="24"><path fill="#263238" fill-opacity=".45" d="M11.999 14.942c2.001 0 3.531-1.53 3.531-3.531V4.35c0-2.001-1.53-3.531-3.531-3.531S8.469 2.35 8.469 4.35v7.061c0 2.001 1.53 3.531 3.53 3.531zm6.238-3.53c0 3.531-2.942 6.002-6.237 6.002s-6.237-2.471-6.237-6.002H3.761c0 4.001 3.178 7.297 7.061 7.885v3.884h2.354v-3.884c3.884-.588 7.061-3.884 7.061-7.885h-2z"></path></svg>
                            </div> */}
                            <button>Send</button>
